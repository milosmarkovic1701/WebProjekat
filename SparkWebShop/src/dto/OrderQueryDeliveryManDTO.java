...
public class OrderQueryDeliveryManDTO {
	...
	public OrderQueryDeliveryManDTO(int deliverymanId, String restaurantName, String priceDown, String priceUp,
			String dateDown, String dateUp, String filterType, String filterStatus, String sort) {
		super();
		this.deliverymanId = deliverymanId;
		this.restaurantName = restaurantName;
		this.priceDown = priceDown;
